...
[fed_mdls_sel_FedProx, trn_perf_sel_FedProx, 
 tst_perf_sel_FedProx] = train_FedProx(data_obj=data_obj, act_prob=act_prob, learning_rate=learning_rate, batch_size=batch_size,
...
plt.plot(np.arange(com_amount)+1, tst_perf_sel_FedProx[:,1], label='FedAvg')
...
plt.savefig('Output/%s/Plot Test Accuracy.pdf' %data_obj.name, dpi=1000, bbox_inches='tight')
